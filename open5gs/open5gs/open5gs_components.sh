case $OPEN5GS_COMPONENT in
	...
	pcrf)
		...
		sed -i "s/KAMAILIO_PCSCF_IP/$KAMAILIO_PCSCF_IP/g" /open5gs/install/etc/freeDiameter/pcrf.conf
		sed -i "s/OPENIMS_PCSCF_IP/$OPENIMS_PCSCF_IP/g" /open5gs/install/etc/freeDiameter/pcrf.conf
