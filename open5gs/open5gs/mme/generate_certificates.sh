...
openssl req -new -batch -x509 -days 365 -nodes -newkey rsa:1024 -out $OPEN5GS_COMPONENT.cert.pem -keyout $OPEN5GS_COMPONENT.key.pem -subj /CN=$OPEN5GS_COMPONENT.$IMS_DOMAIN
